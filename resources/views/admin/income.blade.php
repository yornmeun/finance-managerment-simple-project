...
<script>
	...
	$(function(){
		...
		$("#btnsave").click(function(){
			...
			$.post('insertincome',{txtamount:txtamount,bankname:bankname,txtdate:txtdate,txtdis:txtdis},function(result){
				//alert(result);
				window.location.href="income";
			})
		});

		$("#tableincome").on('click','#btnedit',function(){
        
        	//alert ("test");
        var current_row=$(this).closest("tr");
        var incomeid = current_row.find("td").eq(0).text();
        ...
        $("#btnsavechange").click(function(){
			//alert("test");
          var incomeid=$(this).closest("tr").find("td").eq(0).text();
          ...
          $.post('updateincome',{incomeid:incomeid,amount:amount,bank_name:bank_name,descrition:descrition,date:date},function(data){
			//alert(data);
           window.location.href="income";
          })
		...
		$("#tableincome").on('click','#btndelete',function(){
        var id=$(this).closest("tr").find("td").eq(0).text();

        //alert(id);
        $.post("deleteincome",{income_id:id},function(result){
          //alert (result);
          window.location.href="income";
        })
      });
		    ...
		    <div class="container-xl">
			    <div class="position-relative mb-3">
				    <div class="row g-3 justify-content-between">
					    <div class="col-auto">
					        <h1 class="app-page-title mb-0">Manage Income</h1>
					    </div>
                ...
                <div class="app-card app-card-notification shadow-sm mb-4">
				    <div class="app-card-header px-4 py-3">
				        <div class="row g-3 align-items-center">
					      <table class="table app-table-hover  text-left" id="tableincome">
						  <thead>
							<tr>
